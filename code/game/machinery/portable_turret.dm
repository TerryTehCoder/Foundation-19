...
/obj/machinery/porta_turret
	...
	req_access = list(list(ACCESS_SECURITY_LVL1, ACCESS_ADMIN_LVL3)) //Placeholders, manually adjust the turret or add in a subtype if you want different access requirements.
